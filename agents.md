...
- Use the shared PGlite integration-test timeout for database-backed indexer tests; concurrent Linux runners can exceed Vitest's unit-test default during WASM startup.
